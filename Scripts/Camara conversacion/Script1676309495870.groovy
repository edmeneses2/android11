...
Mobile.tap(findTestObject('Object Repository/camara conversacion/android.widget.LinearLayout'), 1)

Mobile.tap(findTestObject('Object Repository/camara conversacion/android.view.ViewGroup'), 0)

Mobile.tap(findTestObject('Object Repository/camara conversacion/android.widget.ImageButton'), 1)
