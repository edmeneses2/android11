...
Mobile.verifyElementVisible(findTestObject('Object Repository/tutorial y preguntas/android.widget.ImageButton'), 1)

Mobile.tap(findTestObject('Object Repository/tutorial y preguntas/android.widget.Button - OK (3)'), 0)

Mobile.verifyElementVisible(findTestObject('Object Repository/tutorial y preguntas/android.widget.ImageView (1)'), 1)

Mobile.tap(findTestObject('Object Repository/tutorial y preguntas/android.widget.Button - OK (4)'), 0)

Mobile.verifyElementVisible(findTestObject('Object Repository/tutorial y preguntas/android.widget.ImageView (2)'), 1)
