...
Mobile.tap(findTestObject('Documentos conversacion/android.view.ViewGroup'), 0)

Mobile.tap(findTestObject('Object Repository/Documentos conversacion/android.widget.ImageButton'), 1)
